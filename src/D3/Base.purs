...
import D3.Base.Attributes (Attr(..), NumberWithUnit(..), computeDX, computeDY, computeFill, computeRadius, computeStrokeColor, computeStrokeOpacity, computeStrokeWidth, computeText, computeTextAnchor, computeX, computeY, dx, dy, fill, fontFamily, fontSize, radius, strokeColor, strokeOpacity, strokeWidth, textAnchor, viewBox, x, y)
