...
import D3.Base.Attributes (Attr(..), DomUnit(..), computeDX, computeDY, computeFill, computeRadius, computeStrokeColor, computeStrokeOpacity, computeStrokeWidth, computeText, computeTextAnchor, computeX, computeY, dx, dy, fill, fontFamily, fontSize, radius, strokeColor, strokeOpacity, strokeWidth, textAnchor, viewBox, x, y)
import D3.Base.Foreign (Datum, NativeSelection, Scale, SubModel, d3SchemeCategory10JS)
import D3.Base.Selection (Element(..), EnterUpdateExit, Label, Selection(..), Selector, append, append_, extendSelection, join, nameSelection, selectInDOM, simpleJoin, (<-+->), (<->))
